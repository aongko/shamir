 ...
 *
 * The followings are the available columns in table 'master_menu':
 ...
 */
class MasterMenu extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return MasterMenu the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('menu_name, user_input', 'length', 'max'=>50),
			array('status_record', 'length', 'max'=>1),
			array('input_date', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('menu_id, menu_name, user_input, input_date, status_record', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'trPriviledges' => array(self::HAS_MANY, 'TrPriviledge', 'menu_id'),
		);
	}
